            ...
            child: Column(
              ...
              children: [
                ...
                _buildChecklistItem(
                  ...
                  true,
                  _selectedOptionA,
                  (val) => setState(() => _selectedOptionA = val),
                ),
                _buildChecklistItem(
                  'b. Tỉnh dậy lúc nửa đêm hoặc sáng sớm',
                  true,
                  _selectedOptionB,
                  (val) => setState(() => _selectedOptionB = val),
                ),
                _buildChecklistItem(
                  'c. Phải dậy để đi vệ sinh',
                  true,
                  _selectedOptionC,
                  (val) => setState(() => _selectedOptionC = val),
                ),
                _buildChecklistItem(
                  'd. Khó thở',
                  true,
                  _selectedOptionD,
                  (val) => setState(() => _selectedOptionD = val),
                ),
                _buildChecklistItem(
                  'e. Ác mộng',
                  true,
                  _selectedOptionE,
                  (val) => setState(() => _selectedOptionE = val),
                ),
