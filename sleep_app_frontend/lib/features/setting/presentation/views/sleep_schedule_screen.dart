...
class SleepScheduleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ScheduleViewModel()..loadSchedule(),
      child: const _SleepScheduleView(),
    );
  }
}

class _SleepScheduleView extends StatefulWidget {
  const _SleepScheduleView();

  @override
  State<_SleepScheduleView> createState() => _SleepScheduleViewState();
}
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<int>(
                      value: vm.reminderOffsetMinutes,
                      isExpanded: true,
